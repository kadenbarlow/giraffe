...
Giraffe is a CLI and TUI graphql client. Inspired by mainly by [Posting](https://github.com/darrenburns/posting), but also by
[Postman](https://www.postman.com/), [Insomnia](https://www.insomnia.rest/).
...
- Query and mutation generation with variables
- Request history
- Syntax highlighting

## Installation

Giraffe can be installed using `brew` or `npm` and currently has only been tested on MacOS.
